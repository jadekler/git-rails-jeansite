@blogs.push(Blog.create({title: 'Solarize Your Dev Tools Console', created_at: DateTime.parse('15-09-2014'), content: "Lately, the Denver Pivotal Labs office has undergone a [Solarized Theme](http://ethanschoonover.com/solarized) surge - all of our IDEs and terminals have all been swept by the light, eye-calming tan wave. A colleague and I decided to take it a step further while a couple of rather long tests were running. Here you have it: how to solarize your chrome developer tools! Note: you can also see this [at my GitHub](https://github.com/jadekler/solarized-chrome-devtools).
